Firmware Error (ACPI): Failure creating named object [_DID], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [_DID], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [_DID], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [_NXD], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [_NXD], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._DD1], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._DD1], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._CP1], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._CP1], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._CP1], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._CP1], AE_ALREADY_EXISTS (20230628/dsfield-711)
Firmware Error (ACPI): Failure creating named object [\_SB.PCI0.GFX0._CP1], AE_ALREADY_EXISTS (20230628/dsfield-711)
 ...
 *
 * Disassembly of SSDT_0031bf.dat, Tue Sep  8 20:10:33 2026
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000031B6 (12726)
 *     Revision         0x02
 *     Checksum         0x20 **** Incorrect checksum, should be 0x7C
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (BCLP, UnknownObj)
    External (C___, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (CPSC, UnknownObj)
    External (DBTB, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (DD12, UnknownObj)
    External (DD13, UnknownObj)
    External (DD14, UnknownObj)
    External (DD15, UnknownObj)
    ...
    External (GEFC, UnknownObj)
    External (GUAM, MethodObj)    // 1 Arguments
    External (GXFC, UnknownObj)
    External (HV__, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (IMT_, UnknownObj)
    External (IP_S, UnknownObj)
    External (NXD6, IntObj)
    External (NXD7, IntObj)
    External (NXD8, IntObj)
    External (NXDX, IntObj)
    External (OSYS, IntObj)
    External (PNHM, IntObj)
    External (S0ID, UnknownObj)
    External (SCIE, UnknownObj)

    OperationRegion (SANV, SystemMemory, 0x8AA79418, 0x01F7)
