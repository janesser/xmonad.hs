 ...
 *
 * Disassembly of SSDT_000bac.dat, Tue Sep  8 20:10:33 2026
 *
...
DefinitionBlock ("", "SSDT", 2, "INTEL", "xh_rvp03", 0x00000000)
{
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS02)
    {
        Device (FCAM)
        {
            ...
            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
            {
                ...
                Return (UPCP) /* \_SB_.PCI0.XHC_.RHUB.HS02.FCAM._UPC.UPCP */
            }
            ...
            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
            {
                ...
                Return (PLDP) /* \_SB_.PCI0.XHC_.RHUB.HS02.FCAM._PLD.PLDP */
            }
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS03)
    {
        ...
        Method (DS01, 1, Serialized)
        {
            ...
            Return (UPCP) /* \_SB_.PCI0.XHC_.RHUB.SS03.DS01.UPCP */
        }
        ...
        Method (DS02, 1, Serialized)
        {
            ...
            CreateField (DerefOf (PLDP [Zero]), 0x70, 0x08, ROTA)
            ...
            Return (PLDP) /* \_SB_.PCI0.XHC_.RHUB.SS03.DS02.PLDP */
        }
        ...
        Device (CDPT)
        {
            ...
            {
                Return (DSPR) /* External reference */
            }
        ...
        Device (CLRY)
        {
            ...
            Method (_ADR, 0, Serialized)  // _ADR: Address
            {
                Return (DSAD) /* External reference */
            }
